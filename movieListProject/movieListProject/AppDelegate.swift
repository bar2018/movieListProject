...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        self.splashScreen()
        //PersistenceService.context.applicationDocumentsDirectory()
        return true
    } 
    ...
    private func splashScreen() {
        ...
        Timer.scheduledTimer(timeInterval: 1.3, target: self, selector: #selector(dismissSplasController), userInfo: nil, repeats: false)
    }
    
    @objc func dismissSplasController () {
